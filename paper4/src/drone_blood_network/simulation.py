...
from .temperature import adjusted_mission_range_km, resolve_temperature_scenario
...
def run_mission_simulation(
    ...
    available_mission_range_km = adjusted_mission_range_km(
    ...
    for _, row in assignments.iterrows():
        ...
        for day in range(1, settings.simulation_days + 1):
            ...
            utilization = round_trip_distance_km / available_mission_range_km
            ...
            simulated_days.append(
                {
                    ...
                    "battery_performance_factor": row.get(
                        "battery_performance_factor", 1.0
                    ),
                    "effective_mission_range_km": available_mission_range_km,
                }
            )
